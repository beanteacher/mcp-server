    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-surface-card border-b border-neutral-200/10 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="md:hidden p-2 text-neutral-400 hover:text-neutral-50"
      ...
      {isOpen && (
        <div className="fixed top-16 left-0 right-0 z-40 bg-surface-card border-b border-neutral-800 md:hidden">
